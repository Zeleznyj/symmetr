...
Full documentation for the program is available `here <https://symmetr.readthedocs.io>`_. The physics behind the code and the code structure is described in detail in the `manuscript <https://arxiv.org/abs/2602.21034>`_.
